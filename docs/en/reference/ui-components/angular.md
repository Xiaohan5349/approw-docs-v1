...
3. Call the method of `AuthenticationClient` instance.  For a complete list of methods, please see the [AuthenticationClient method list](/en/reference/sdk-for-node/authentication/AuthenticationClient).
