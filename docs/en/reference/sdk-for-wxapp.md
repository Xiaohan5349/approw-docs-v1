...
2. 在 [{{$localeConfig.brandName}} 控制台](https://console.authing.cn/console/userpool)开启微信小程序社会化登录。

- 获取微信小程序 AppId 和 AppSecret

![](https://cdn.authing.cn/blog/20201112143117.png)

- 前往 [{{$localeConfig.brandName}} 控制台](https://console.authing.cn/console/userpool) **连接身份源** - **社会化登录** - **小程序内登录**:
