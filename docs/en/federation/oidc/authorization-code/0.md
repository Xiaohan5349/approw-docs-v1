...
```
https://<your applicaion domain id>.approw.con/oidc/auth?client_id=5c9b079883e333d55a101082&redirect_uri=https://www.example.cn/example&scope=openid profile&response_type=code&state=52378542395
```
...
```
https://<your application domain name>.approw.cn/oidc/auth?client_id=5c9b079883e333d55a101082&redirect_uri=https://example.com&scope=openid profile offline_access&response_type=code&prompt=consent&state=235345
```

Reference：

1. [Scope and user information correspondence table](docs/en/concepts/oidc-common-questions.md#scope-参数对应的用户信息)
