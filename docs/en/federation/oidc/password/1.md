...
<ApiMethodSpec method="post" host="https://<your applicaion domain name>.approw.cn" path="/oidc/token" summary="Use login credentials to exchange token" description="In Password mode, you can directly use the user's login credentials in exchange for OIDC token">
...
1. [Scope and user information correspondence table](/docs/en/oidc-params.md#information-stored-in-socpe)
