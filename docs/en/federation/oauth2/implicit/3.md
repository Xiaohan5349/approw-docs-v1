...
<ApiMethodSpec method="get" host="https://core.approw.cn" path="/oauth/me" summary="Use access_token in exchange for user information">
...
Request link example：https://core.approw.cn/oauth/me?access_token={access_token}
