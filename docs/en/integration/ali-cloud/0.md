...
Create an application on {{$localeConfig.brandName}}. Enter [**Console**](https://console.authing.cn) > **Applications**, click “Create Application”.
...
```json {13}
{
  ...
  "emailDomainSubstitution": "authing.onaliyun.com" // Change to your Alibaba Cloud domain name
}
```
