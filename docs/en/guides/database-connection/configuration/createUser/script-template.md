...
When the user is created successfully, you need to return the user information to Approw, the format of user information can be found in the document of [of detailed fields of the user profile](/doc/en/guides/user/user-profile.md). For example:
