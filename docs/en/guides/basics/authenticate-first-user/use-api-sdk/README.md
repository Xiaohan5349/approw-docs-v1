...
<StackSelector snippet="init-sdk" selectLabel="choose language" :order="['java', 'javascript', 'swift', 'python', 'csharp']"/>
...
<StackSelector snippet="send-sms-code" selectLabel="choose language" :order="['java', 'javascript', 'swift', 'python', 'csharp']"/>

And then, use the SMS code to login.

<StackSelector snippet="login-by-phone-code" selectLabel="choose language" :order="['java', 'javascript', 'swift', 'python', 'csharp']"/>
