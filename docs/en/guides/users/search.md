...
Approw supports using fields such as mailbox, user name, mobile phone number, nickname, etc to do the fuzzy search to users in both [console](#Search for users using console) and [SDK](#Search for users using SDK) modes:
